...
3. Map: subject→id, name→displayName, email, email_verified, selected_team_id→selectedTeamId (null if the claim is absent), is_anonymous, is_restricted, restricted_reason
