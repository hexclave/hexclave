                ...
                <div className="space-y-2">
                  {appliedPromoCodeNames.map((codeName) => (
                    <div key={codeName} className="flex items-center justify-between text-sm">
                      <span>{t("With Code")} {codeName}</span>
                      <Button
                        variant="ghost"
                        size="sm"
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button
                        ...
                        onClick={async () => {
                          ...
                          if (result.status === "error") {
                            setPromoError(promoApplyErrorMessage(result.error, t("This promo code could not be applied.")));
                            return;
                          }
                  ...
                  {promoError != null && (
                    <Typography variant="secondary" className="text-red-500 text-xs">{promoError}</Typography>
                  )}
                </div>
              )}
            </div>
