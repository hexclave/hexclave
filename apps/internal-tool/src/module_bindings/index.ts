...
const reducersSchema = __reducers(
  ...
  __reducerSchema("clear_demo_seed", ClearDemoSeedReducer),
...
const proceduresSchema = __procedures(
  __procedureSchema("page_ai_query_log", PageAiQueryLogProcedure.params, PageAiQueryLogProcedure.returnType),
  __procedureSchema("page_feedback_log", PageFeedbackLogProcedure.params, PageFeedbackLogProcedure.returnType),
  __procedureSchema("page_mcp_call_log", PageMcpCallLogProcedure.params, PageMcpCallLogProcedure.returnType),
);
