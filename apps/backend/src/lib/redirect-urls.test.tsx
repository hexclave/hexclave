  ...
  describe('exact domain matching', () => {
    ...
    it('should trust both current and legacy cloud hosted handler domains', () => {
      withHostedHandlerEnv({}, () => {
        ...
        expect(validateRedirectHostname('deploy-example.built-with-hexclave.com', tenancy)).toBe(false);
        expect(validateRedirectUrl('https://deploy-example.built-with-hexclave.com/handler/oauth-callback', tenancy)).toBe(false);
